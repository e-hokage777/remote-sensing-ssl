...
def plot_scatter(
    component_1: Iterable,
    component_2: Iterable,
    axis: Axes,
    title: str,
    c: Iterable = None,
):
    assert len(component_1) == len(
        component_2
    ...
    if c is not None:
        ...
        for label in unique_labels:
            ...
            axis.scatter(
                [component_1[i] for i in mask],
                [component_2[i] for i in mask],
                s=16,
...
def generate_plot(root_dir: str, dataset_id: str, save_path: str):
    ...
    for i, file in enumerate(files):
        ...
        plot_scatter(
            component_1=features_decomposed["component_0"],
...
def generate_individual_plots(root_dir: str, dataset_id: str, save_path: str):
    files = glob(f"{root_dir}/{dataset_id}*.csv")
